...
export default function DashboardPage() {
  ...
  // Browsing dates is a VIEW action — anyone who can open the dashboard may look
  // at any day. What a non-admin cannot do is write outside their edit window,
  // and that is enforced where the writing happens (and by RLS).
      ...
      <div className="animate-fade-in">
        ...
        <div className="px-4 mb-3 flex items-center justify-between gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 border rounded-xl text-xs font-semibold transition-all shadow-sm min-h-[38px] bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:border-teal-500 hover:text-teal-650 active:scale-95"
          >
            <span>◀</span>
            <span>Previous</span>
          </button>
