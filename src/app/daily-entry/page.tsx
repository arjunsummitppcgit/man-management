            ...
            {activeTab === 'workforce' && (
              <div className="animate-fade-in space-y-4">
                ...
                <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
                  <h3 className="text-sm font-semibold text-gray-700 mb-3">Assign Supervisors</h3>
                  <div className="flex flex-wrap gap-2">
                    {candidateSupervisors.map((sup) => {
                        ...
                        <button
                          ...
                          className={`px-3 py-2 rounded-xl text-xs font-medium transition-all min-h-[36px] ${
                            isSelected
                              ...
                              : 'bg-gray-50 text-gray-600 border border-gray-200 hover:border-teal-300'
                          }`}
                        >
                          {isSelected && (
